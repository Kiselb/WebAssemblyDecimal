DECLARE @MAX_VALUE AS NVARCHAR(255) = CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CAST('99999999999999999999999999999999999999' AS DECIMAL(38, 0))), 1)
DECLARE @MIN_DELTA AS NVARCHAR(255) = CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CAST('0.00000000000000000000000000000000000001' AS DECIMAL(38, 38))), 1)

DECLARE @MULTIPLEXER AS INT = 0
...
BEGIN
	...
	IF (@MULTIPLEXER = 37) -- Change on value from 0 to 37 to view result
		SELECT @RESULT
