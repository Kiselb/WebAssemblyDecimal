	DECLARE @DS0 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 0), '10')), 1) + '00000000000000000000000000000000', 42)
	SET @DS0 = ''
	...
	DECLARE @DS1 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 1), '10.0')), 1) + '00000000000000000000000000000000', 42)
	SET @DS1 = ''
	...
	DECLARE @DS2 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 2), '10.00')), 1) + '00000000000000000000000000000000', 42)
	SET @DS2 = ''
	...
	DECLARE @DS3 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 3), '10.000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS3 = ''
	...
	DECLARE @DS4 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 4), '10.0000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS4 = ''
	...
	DECLARE @DS5 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 5), '10.00000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS5 = ''
	...
	DECLARE @DS6 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 6), '10.000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS6 = ''
	...
	DECLARE @DS7 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 7), '10.0000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS7 = ''
	...
	DECLARE @DS8 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 8), '10.00000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS8 = ''
	...
	DECLARE @DS9 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 9), '10.000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS9 = ''
	...
	DECLARE @DS10 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 10), '10.0000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS10 = ''
	...
	DECLARE @DS11 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 11), '10.00000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS11 = ''
	...
	DECLARE @DS12 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 12), '10.000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS12 = ''
	...
	DECLARE @DS13 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 13), '10.0000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS13 = ''
	...
	DECLARE @DS14 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 14), '10.00000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS14 = ''
	...
	DECLARE @DS15 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 15), '10.000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS15 = ''
	...
	DECLARE @DS16 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 16), '10.0000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS16 = ''
	...
	DECLARE @DS17 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 17), '10.00000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS17 = ''
	...
	DECLARE @DS18 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 18), '10.000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS18 = ''
	...
	DECLARE @DS19 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 19), '10.0000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS19 = ''
	...
	DECLARE @DS20 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 20), '10.00000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS20 = ''
	...
	DECLARE @DS21 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 21), '10.000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS21 = ''
	...
	DECLARE @DS22 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 22), '10.0000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS22 = ''
	...
	DECLARE @DS23 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 23), '10.00000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS23 = ''
	...
	DECLARE @DS24 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 24), '10.000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS24 = ''
	...
	DECLARE @DS25 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 25), '10.0000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS25 = ''
	...
	DECLARE @DS26 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 26), '10.00000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS26 = ''
	...
	DECLARE @DS27 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 27), '10.000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS27 = ''
	...
	DECLARE @DS28 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 28), '10.0000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS28 = ''
	...
	DECLARE @DS29 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 29), '10.00000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS29 = ''
	...
	DECLARE @DS30 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 30), '10.000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS30 = ''
	...
	DECLARE @DS31 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 31), '10.0000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS31 = ''
	...
	DECLARE @DS32 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 32), '10.00000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS32 = ''
	...
	DECLARE @DS33 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 33), '10.000000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS33 = ''
	...
	DECLARE @DS34 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 34), '10.0000000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS34 = ''
	...
	DECLARE @DS35 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 35), '10.00000000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS35 = ''
	...
	DECLARE @DS36 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 36), '10.000000000000000000000000000000000000')), 1) + '00000000000000000000000000000000', 42)
	SET @DS36 = ''
