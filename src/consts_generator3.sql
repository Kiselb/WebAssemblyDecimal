	DECLARE @DS0 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 1), '0.1')), 1) + '00000000000000000000000000000000', 42)
	SET @DS0 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale01, '
	...
	DECLARE @DS1 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 2), '0.01')), 1) + '00000000000000000000000000000000', 42)
	SET @DS1 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale02, '
	...
	DECLARE @DS2 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 3), '0.001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS2 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale03, '
	...
	DECLARE @DS3 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 4), '0.0001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS3 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale04, '
	...
	DECLARE @DS4 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 5), '0.00001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS4 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale05, '
	...
	DECLARE @DS5 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 6), '0.000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS5 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale06, '
	...
	DECLARE @DS6 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 7), '0.0000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS6 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale07, '
	...
	DECLARE @DS7 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 8), '0.00000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS7 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale08, '
	...
	DECLARE @DS8 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 9), '0.000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS8 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale09, '
	...
	DECLARE @DS9 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 10), '0.0000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS9 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale10, '
	...
	DECLARE @DS10 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 11), '0.00000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS10 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale11, '
	...
	DECLARE @DS11 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 12), '0.000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS11 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale12, '
	...
	DECLARE @DS12 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 13), '0.0000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS12 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale13, '
	...
	DECLARE @DS13 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 14), '0.00000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS13 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale14, '
	...
	DECLARE @DS14 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 15), '0.000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS14 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale15, '
	...
	DECLARE @DS15 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 16), '0.0000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS15 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale16, '
	...
	DECLARE @DS16 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 17), '0.00000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS16 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale17, '
	...
	DECLARE @DS17 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 18), '0.000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS17 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale18, '
	...
	DECLARE @DS18 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 19), '0.0000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS18 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale19, '
	...
	DECLARE @DS19 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 20), '0.00000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS19 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale20, '
	...
	DECLARE @DS20 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 21), '0.000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS20 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale21, '
	...
	DECLARE @DS21 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 22), '0.0000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS21 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale22, '
	...
	DECLARE @DS22 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 23), '0.00000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS22 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale23, '
	...
	DECLARE @DS23 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 24), '0.000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS23 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale24, '
	...
	DECLARE @DS24 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 25), '0.0000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS24 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale25, '
	...
	DECLARE @DS25 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 26), '0.00000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS25 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale26, '
	...
	DECLARE @DS26 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 27), '0.000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS26 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale27, '
	...
	DECLARE @DS27 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 28), '0.0000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS27 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale28, '
	...
	DECLARE @DS28 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 29), '0.00000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS28 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale29, '
	...
	DECLARE @DS29 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 30), '0.000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS29 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale30, '
	...
	DECLARE @DS30 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 31), '0.0000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS30 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale31, '
	...
	DECLARE @DS31 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 32), '0.00000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS31 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale32, '
	...
	DECLARE @DS32 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 33), '0.000000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS32 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale33, '
	...
	DECLARE @DS33 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 34), '0.0000000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS33 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale34, '
	...
	DECLARE @DS34 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 35), '0.00000000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS34 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale35, '
	...
	DECLARE @DS35 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 36), '0.000000000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS35 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale36, '
	...
	DECLARE @DS36 AS NVARCHAR(4000) = LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), CONVERT(DECIMAL(38, 37), '0.0000000000000000000000000000000000001')), 1) + '00000000000000000000000000000000', 42)
	SET @DS36 = ''
		+ CHAR(9) + N'Decimal { sign: DecimalSign::Positive, precision: DecimalPrecision::Precision38, scale: DecimalScale::Scale37, '
...
SELECT @DS30 + @DS31 + @DS32 + @DS33 + @DS34 + @DS35 + @DS36 AS F0
