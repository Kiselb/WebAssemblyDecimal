...
--DECLARE @A AS DECIMAL(38, 0) = CAST('2222222222222' AS DECIMAL(38, 0))
--DECLARE @B AS DECIMAL(38, 0) = CAST('1111111111111' AS DECIMAL(38, 0))
--SELECT LEFT(CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), @A * @B), 1) + '00000000000000000000000000000000', 42) AS A, CAST(@A * @B AS NVARCHAR(255)) AS B

DECLARE @A AS DECIMAL(38, 0) = CAST('10' AS DECIMAL(38, 0))
DECLARE @B AS DECIMAL(38, 2) = CAST('10' AS DECIMAL(38, 2))
SELECT CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), @A), 1) -- 0A:		10
SELECT CONVERT(NVARCHAR(255), CONVERT(VARBINARY(32), @B), 1) -- 03 E8:	1000
